...
@connect(state => ({
    grossProfitByCustomer: state.grossProfitByCustomer,
}))
export default class grossProfitByCustomer extends PureComponent {
    componentDidMount() {
        const { dispatch } = this.props;
        dispatch({
            type: 'grossProfitByCustomer/getList',
        });
    }
    componentWillUnmount() {
        const { dispatch } = this.props;
        dispatch({
            type: 'grossProfitByCustomer/unmountReducer',
        });
    }
    handleChangeMenu=(e)=>{
        const { dispatch } = this.props;
    ...
    handleChangeSearchKeyWords=(e)=>{
        const { dispatch } = this.props;
        dispatch({
            type: 'grossProfitByCustomer/updatePageReducer',
            payload:{
  ...
  render() {
    const {
        ...
        pageSize,
        total,
    } = this.props.grossProfitByCustomer;
    function fmoney(s, n) {
        n = n > 0 && n <= 20 ? n : 2;
            ...
            <Row gutter={16} style={{ marginTop:10 }}>
                <Col span={20}>
                    ...
                    <Search
                        ...
                        onChange={this.handleChangeSearchKeyWords}
