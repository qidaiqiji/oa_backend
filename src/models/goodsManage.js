...
import { reqGetConfig, reqChangeGoodsFloorPrice, reqGetGoodsList, reqChangeGoodsTaxFloorPrice } from '../services/goodsManage';
  ...
  effects: {
    *mount(_, { put, call, all, select }) {
      const {
        ...
        curPage,
        pageSize,
      } = yield select(state => state.goodsManage);
