...
export default class AfterSaleOrderList extends PureComponent {
  ...
  render() {
    ...
    const orderColumns = [
      ...
      {
        title: '商户售后单编号',
        dataIndex: 'merchantBackOrderSn',
        key: 'merchantBackOrderSn',
      },
      {
        title: '商户备注',
        dataIndex: 'merchantBackOrderRemark',
        key: 'merchantBackOrderRemark',
        render: merchantBackOrderRemark => (
          <Tooltip title={merchantBackOrderRemark}>
            <span className={globalStyles['ellipsis-col']}>{merchantBackOrderRemark}</span>
          </Tooltip>
        ),
      },
      {
